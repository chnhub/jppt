...
public class DruidDBConfig {
    ...
    public SqlSessionFactory sqlSessionFactory() throws Exception {
        ...
        sqlSessionFactoryBean.setMapperLocations(resolver.getResources("classpath:com/wellcom/jppt/biz/**/dao/mapper/*.xml"));
     ...
     */
    // @Bean
    // @ConfigurationProperties(prefix = "mybatis-config.xml")
